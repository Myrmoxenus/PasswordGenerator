...
// Button sets test and admissible character arrays empty before calling the series of prompts to reset between button presses.
...
var testers = [noLowerTest, noUpperTest, noSpecialsTest, noNumbersTest]
...
function passwordBuilder(currentString) {
  if (currentString.length === passwordLength){
      failedTests = 0
      console.log("Passed to quality control")
     return qualityControl(currentString)
  }
  else {
